...
const sabiaLogo = document.querySelector('.sabia-menu-img')
...
function showHeader(){
    ...
    if ((window.pageYOffset > 0) && (window.pageYOffset < rect - tamanhoHeader)) {
        ...
        sabiaLogo.classList.remove("sabia-menu-img");
        sabiaLogo.classList.add("fixed-sabia-menu-img");
    } 
    
    else {
        header.classList.remove("fixed-header");
        header.classList.remove("fixed-background");
        sabiaLogo.classList.remove("fixed-sabia-menu-img");
        sabiaLogo.classList.add("sabia-menu-img");
    }
}
